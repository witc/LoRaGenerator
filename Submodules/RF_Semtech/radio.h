 ...
 */
void RadioSetRxConfig(uint32_t freq, RadioModems_t modem, uint32_t bandwidth,
                          uint32_t sf_datarate, uint8_t coderate,
 ...
 */
void RadioSetTxConfig(uint32_t freq, RadioModems_t modem, int8_t power, uint32_t fdev,
                          uint32_t bandwidth, uint32_t sf_datarate,
...
/*
 * brief Clear all IRQ flags in sx126x
 */
void RadioClearAllIRQs();
